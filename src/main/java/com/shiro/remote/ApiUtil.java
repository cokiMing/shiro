...
public class ApiUtil {
     ...
     * @return
     */
    public static JSONObject getStepsByGoogleMap(Double originLat,Double originLng,Double desLat,Double desLng){
    ...
    public static void main(String args[]){
        ...
        JSONObject steps = getStepsByGoogleMap(40.8171321, -73.996854, 40.7516627, -74.0725247);
